...
export default function Resources() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50/30 via-white to-purple-50/20">
      ...
      {/* Footer */}
      <footer className="bg-indigo-700 text-white py-16 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 mb-12">
            <div>
              <h4 className="font-bold mb-4 text-sm uppercase tracking-wider">Website</h4>
            ...
            <div className="md:col-span-2">
              ...
              <ul className="space-y-2 text-sm text-indigo-100">
                <li><a href="#" className="hover:text-white transition-colors">Start-up & Growth Advisory</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Accounting & Financial Management</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Taxation & Compliance Consulting</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Corporate & Legal Solutions</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Audit & Assurance Services</a></li>
              </ul>
            </div>
