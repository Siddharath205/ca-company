...
export default function ConsultingLandingPage() {
  return (
    <div className="font-sans text-gray-800">
      ...
      {/* ================= TESTIMONIALS ================= */} <section className="bg-[#FEEDEF] py-24"> <div className="max-w-7xl mx-auto px-6 text-center"> <p className="text-indigo-600 text-sm font-semibold">TESTIMONIALS</p> <h2 className="text-3xl font-bold mt-2">What Our Clients Say</h2> <div className="grid md:grid-cols-4 gap-6 mt-14"> {[...Array(8)].map((_, i) => (<div key={i} className="bg-white rounded-xl p-4 text-sm shadow"> <p> The team was extremely professional and supportive. They helped us navigate complex compliance smoothly. </p> <p className="mt-4 font-semibold">Santosh</p> <p className="text-xs text-gray-400">Director</p> </div>))} </div> </div> </section>
